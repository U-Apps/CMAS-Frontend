      ...
      <div className=" w-full h-screen ">
        <div className="warp container  mx-auto  py-10">
          ...
          <form
            ...
            className="flex h-[60%] grid grid-cols-2 gap-10"
          >
            <div className="form-group flex  flex-col gap-y-2">
              ...
              <input
                ...
                name="firstName"
                className="border border-gray-300 py-[5px] px-2 rounded-md "
                required
              />
            </div>
            <div className="form-group flex   flex-col gap-y-2">
            ...
            <div className="btns col-span-2 flex   gap-y-2 justify-end  gap-x-[15px]">
              <button
                type="button"
                className="btn px-2 py-1 rounded  w-[100px] border border-gray-300 hover:bg-blue-400 hover:border-blue-500 "
              >
                update
              </button>
              <button
